...
Certains utilisateurs d'**AAPS** expérimentés et sûr d'eux font des tests avec les technologies émergentes et avec les versions de développement de l'application **AAPS**. Les gens ont tendance à partager ces expériences sur le groupe Facebook.
