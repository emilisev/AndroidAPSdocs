...
When first embarking on your **AAPS** journey, you will need to create a **Profile**, understand how to action a **Profile Switch** and learn the impact of a **Profile Percentage** within **AAPS**. You can learn about how to create a **Profile** at [Config Builder - profile](#setup-wizard-profile).

You can learn about how to create a **Profile** at [Config Builder - profile](../SettingUpAaps/SetupWizard.md#profile). This section will explain what is a **Profile Switch** and **Profile Percentage**.
