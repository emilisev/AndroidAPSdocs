...
* When it alters the target glucose, the background will change to green.
...
* Last resort: In **AAPS**, go to your [NS Client settings](../Configuration/Preferences.md#nsclient), select the sync settings and disable the "Accept CGM data from NS" option.
...
The yellow warning signal is indicating that your BG arrived in irregular time intervals or that some BGs are missing.
...
Settings can be changed in [preferences](../Configuration/Preferences.md#status-lights).
...
* **Orange** line: [COB](../Usage/COB-calculation.md) (color is used generally to represent COB and carbs)
...
Decaying depends on the [deviations the algorithm detects](../Usage/COB-calculation.md). 
...
This data may be available when using a [Garmin smartwatch](../Configuration/Watchfaces.md#garmin).
...
Other Buttons can be set up in [preferences](../Configuration/Preferences.md#buttons).

*About using the Insulin, Carbs and Calculator* buttons : If enabled in the [Preferences](../Configuration/Preferences.md#show-notes-field-in-treatments-dialogs), the *Notes* field allows you to enter text that will be uploaded to Nightscout - depending on your settings for NS client.
...
By checking the box **Start eating soon TT**, you can automatically start your [eating soon temp target](../Configuration/Preferences.md#default-temp-targets).

If you do not want to bolus through the pump but record an insulin amount (i.e. insulin given by syringe) check the corresponding box.

You can use the buttons to quickly increase the insulin quantity. The increment values can be changed in the [Preferences](../Configuration/Preferences.md#buttons).
...
You can use the buttons to quickly increase the carb amount. The increment values can be changed in the [Preferences](../Configuration/Preferences.md#buttons).
...
Easily enter an amount of carbs and set calculation basics.

Details are set up in [preferences](../Configuration/Preferences.md#quick-wizard).
...
If you see the warning above after using bolus wizard, **AAPS** has detected that the calculated COB value maybe wrong. So, if you want to bolus again after a previous meal with COB you should be aware of overdosing! 
...
See the detailed **[Profile](../Getting-Started/Your-AAPS-Profile.md)** page for more information.
...
Settings can be changed in [preferences](../Configuration/Preferences.md#nsclient).
